<section class="card">
<div class="card-header"><div><h2><?= e($user['full_name']) ?></h2><p><?= e(role_label($user['role'])) ?> · <?= e($user['email'] ?? '-') ?></p></div><div class="actions"><a class="btn btn-edit" href="<?= app_url(['page'=>'profile','action'=>'edit']) ?>">Sửa hồ sơ</a><a class="btn btn-light" href="<?= app_url(['page'=>'profile','action'=>'password']) ?>">Đổi mật khẩu</a></div></div>
<?php if ($employee): ?>
<div class="info-grid">
