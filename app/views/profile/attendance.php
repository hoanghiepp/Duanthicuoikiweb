...
<?php foreach ($rows as $r): ?><tr><td><?= e($r['work_date'] ?? '-') ?></td><td><span class="badge <?= e($r['status'] ?? '') ?>"><?= e(attendance_label($r['status'] ?? null)) ?></span></td><td><?= e($r['check_in'] ?? '-') ?></td><td><?= e($r['check_out'] ?? '-') ?></td><td><?= e($r['note'] ?? '-') ?></td></tr><?php endforeach; ?>
